...
"[project]/Desktop/Fifth semester/blockchain/project/frontend/app/api/admin/create-student/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    try {
        ...
        if (!full_name || !student_id || !program || !enrollment_year) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Fifth__semester$2f$blockchain$2f$project$2f$frontend$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: "full_name, student_id, program, enrollment_year are required"
            }, {
                status: 400
            });
        }
        const existing = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Fifth__semester$2f$blockchain$2f$project$2f$frontend$2f$app$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["executeQuery"])("SELECT id FROM students WHERE student_id = ? LIMIT 1", [
            student_id
        ]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6ebcf15d._.js.map