...
async function POST(request) {
    try {
        ...
        const record = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Fifth__semester$2f$blockchain$2f$project$2f$frontend$2f$app$2f$lib$2f$blockchain$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["contract"].verifyRecord(normalizedStudentId);
        const studentRows = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Fifth__semester$2f$blockchain$2f$project$2f$frontend$2f$app$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["executeQuery"])(`
      ...
      `, [
        ...
        SELECT cgpa, issued_at, is_revoked
        FROM certificates
        WHERE student_id = ?
        ORDER BY id DESC
        LIMIT 1
      `, [
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Fifth__semester$2f$blockchain$2f$project$2f$frontend$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ...
            data: {
                ...
                cgpa: certificate.cgpa ?? null,
                documentHash: record.documentHash,
                issuer: record.issuer,
                timestamp: record.timestamp.toString(),
                issueDate: certificate.issued_at || null,
                isValid: record.isValid,
                status: record.isValid && !certificate.is_revoked ? "Valid" : "Revoked"
            }
        }, {
            status: 200
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d3c4b1f3._.js.map