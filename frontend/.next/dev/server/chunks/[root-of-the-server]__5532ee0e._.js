...
"[project]/Desktop/Fifth semester/blockchain/project/frontend/app/api/admin/assign-grade/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    try {
        ...
        if (!student_id || !course_code || !grade || !semester || !year) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Fifth__semester$2f$blockchain$2f$project$2f$frontend$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: "student_id, course_code, grade, semester, year are required"
            }, {
                status: 400
            });
        }
        ...
        const courseExists = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Fifth__semester$2f$blockchain$2f$project$2f$frontend$2f$app$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["executeQuery"])("SELECT id FROM courses WHERE course_code = ? LIMIT 1", [
            course_code
        ]);
      ...
      `, [
        ...
        if (duplicate.length > 0) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Fifth__semester$2f$blockchain$2f$project$2f$frontend$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: "Grade entry already exists for this student/course/semester/year"
            }, {
                status: 409
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5532ee0e._.js.map