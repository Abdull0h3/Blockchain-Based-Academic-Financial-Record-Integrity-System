...
"[project]/Desktop/Fifth semester/blockchain/project/frontend/app/api/admin/add-activity/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    try {
        ...
        if (!student_id || !activity_name) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Fifth__semester$2f$blockchain$2f$project$2f$frontend$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: "student_id and activity_name are required"
            }, {
                status: 400
            });
        }
        const studentExists = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Fifth__semester$2f$blockchain$2f$project$2f$frontend$2f$app$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["executeQuery"])("SELECT id FROM students WHERE student_id = ? LIMIT 1", [
            student_id
        ]);
        ...
        const existingActivity = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Fifth__semester$2f$blockchain$2f$project$2f$frontend$2f$app$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["executeQuery"])("SELECT id FROM activities WHERE activity_name = ? LIMIT 1", [
            activity_name
        ]);
        let activityId;
        if (existingActivity.length > 0) {
            ...
            const insert = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Fifth__semester$2f$blockchain$2f$project$2f$frontend$2f$app$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["executeQuery"])("INSERT INTO activities (activity_name, description) VALUES (?, ?)", [
                String(activity_name).trim(),
                description || null
            ]);
            activityId = insert.insertId;
        }
        const participationDate = participation_date || null;
        const duplicate = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Fifth__semester$2f$blockchain$2f$project$2f$frontend$2f$app$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["executeQuery"])(`
        SELECT id
      ...
      `, [
        ...
        if (duplicate.length > 0) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Fifth__semester$2f$blockchain$2f$project$2f$frontend$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: "Activity participation already exists for this date"
            }, {
                status: 409
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7ec68af0._.js.map